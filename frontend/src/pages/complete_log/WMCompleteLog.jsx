...
// ===== CONFIGURATION =====
const API_BASE_URL = "http://192.168.1.34:1881";
...
// ===== MAIN COMPONENT =====
export default function WMCompleteLog() {
  // ===== STATE MANAGEMENT =====
  ...
  const fetchData = useCallback(async () => {
    ...
    let url = `${API_BASE_URL}/wmcompletelogbook?limit=${rowsPerPage}&offset=${offset}`;
  ...
  const exportToExcel = async (exportAll = true) => {
    ...
    try {
      ...
      const worksheet = workbook.addWorksheet("Complete_Logbook");

      workbook.creator = "EpackWM System";
      ...
      link.download = `EpackWM_Logbook_${
  ...
  const fetchAllData = async () => {
    let url = `${API_BASE_URL}/wmcompletelogbook/export`;
    const params = [];
    ...
    <div className="bg-gray-800 rounded-lg p-4 mb-4 space-y-4">
      <div className="flex flex-wrap gap-3 items-center">
        ...
        <button
          ...
          disabled={!fromDate && !toDate && !searchText}
        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="text-center mb-6">
            <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              EpackWM Sri City – Complete Logbook
            </h1>
          ...
          <div className="mt-8 text-center text-sm text-gray-500">
            ...
            <p className="mt-1">
              Powered by EpackWM Logbook System |{" "}
