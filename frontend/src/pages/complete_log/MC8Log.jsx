...
// ===== MAIN COMPONENT =====
export default function MC8Log() {
  // ===== STATE MANAGEMENT =====
  ...
  const fetchData = useCallback(async () => {
    ...
    let url = `${API_BASE_URL}/usw_mc8?limit=${rowsPerPage}&offset=${offset}`;
  ...
  const exportToExcel = async (exportAll = true) => {
    ...
    try {
      ...
      const worksheet = workbook.addWorksheet("MC8_Logbook");
  ...
  const fetchAllData = async () => {
    let url = `${API_BASE_URL}/usw_mc8/export`;
    const params = [];
