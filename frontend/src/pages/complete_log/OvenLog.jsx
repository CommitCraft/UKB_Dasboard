...
// ===== MAIN COMPONENT =====
export default function OvenLog() {
  // ===== STATE MANAGEMENT =====
  ...
  const fetchData = useCallback(async () => {
    ...
    let url = `${API_BASE_URL}/oventimelog?limit=${rowsPerPage}&offset=${offset}`;
  ...
  const exportToExcel = async (exportAll = true) => {
    ...
    try {
      ...
      const worksheet = workbook.addWorksheet("OvenTime_Logbook");
  ...
  const fetchAllData = async () => {
    let url = `${API_BASE_URL}/oventimelog/export`;
    const params = [];
        ...
        <div className="max-w-[1600px] mx-auto">
          ...
          <div className="text-center mb-6">
            <h1 className="text-4xl font-bold mb-2 bg-gradient-to-r from-blue-400 to-purple-500 bg-clip-text text-transparent">
              EpackCFF Sri City – OvenTime Logbook
            </h1>
